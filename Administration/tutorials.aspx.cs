        ...
        protected void onSubmit(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string fileName = "";
                    var pictureTitle = TutorialTitle.Text;
                    if (fileUpload.HasFile)
                    {
                        // Specify the directory path where you want to save the photo
                        string uploadFolderPath = Server.MapPath("~/Pictures/Tutorials/");
                    ...
                    string query = $"INSERT INTO {tableName} ([title],[path]) VALUES ('" + pictureTitle + "','/Pictures/Tutorials/" + fileName + "')";
