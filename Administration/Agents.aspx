        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Submit">Search</button>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center">
                                        <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../assets/images/avatars/SidneyBroutinovski.jpg" alt="profile"></td>
                                    <td>Foulen</td>
                                    <td>Ben Foulen</td>
                                    <td>Argentina</td> 
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            ...
                                            <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="ProfilAgent.aspx">
                                                <span class="btn-inner">
